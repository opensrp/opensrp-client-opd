...
public class OpdRegisterActivityInteractor implements OpdRegisterActivityContract.Interactor {
    ...
    @Override
    public void saveRegistration(final List<OpdEventClient> opdEventClientList, final String jsonString,final UpdateRegisterParams updateRegisterParams, OpdRegisterActivityPresenter opdRegisterActivityPresenter) {
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
...
//                        callBack.onRegistrationSaved(updateRegisterParams.isEditMode());
    ...
    public void saveRegistration(List<OpdEventClient> opdEventClients, String jsonString,
