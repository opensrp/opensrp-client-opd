...
public class OpdJsonFormUtilsTest {
    ...
    public void testProcessOpdDetailsFormShouldReturnOpdEventClientWithValidJsonForm() {
        ...
        OpdEventClient opdEventClientResult = OpdJsonFormUtils.processOpdDetailsForm(jsonForm, Mockito.mock(FormTag.class));
        Assert.assertNotNull(opdEventClientResult);

        Assert.assertNotNull(opdEventClientResult.getEvent());
        Assert.assertNotNull(opdEventClientResult.getEvent().getBaseEntityId());
        Assert.assertNotNull(opdEventClientResult.getClient().getBaseEntityId());
        Assert.assertEquals("Opd Registration", opdEventClientResult.getEvent().getEventType());
        Assert.assertEquals(team, opdEventClientResult.getEvent().getTeam());
        Assert.assertEquals(teamId, opdEventClientResult.getEvent().getProviderId());
